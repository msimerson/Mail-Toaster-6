...
start_spamassassin()
{
	...
	sysrc -j stage spamd_flags="-v -q -x -u spamd -H /var/spool/spamd -A 127.0.0.0/8 -A $JAIL_NET_PREFIX.0$JAIL_NET_MASK --listen=0.0.0.0 --min-spare=3 --max-spare=6 --max-conn-per-child=25"
