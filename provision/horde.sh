...
install_horde()
{
	...
	install_php 72 "simplexml ftp gd fileinfo tidy" || exit
	install_nginx || exit

	tell_status "installing Horde IMP and Ingo "
	stage_pkg_install php72-horde-ingo
	stage_pkg_install php72-horde-imp
	stage_pkg_install php72-pecl-imagick
}
